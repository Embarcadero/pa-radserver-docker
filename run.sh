...
if [ "$1" == '' ] || [ "$2" == '' ]; then
    ...
    docker run --cap-add=SYS_PTRACE --security-opt seccomp=unconfined \
        -it --mount source=ems,target=/etc/ems -e DB_PORT=$2 -e DB_HOST=$1 \
        -e PA_SERVER_PASSWORD=securepass -p 80:80 -p 64211:64211 -p 8082:8082 radstudio/pa-radserver:11.2 
fi
